...
use "~/Dropbox/Double Q Survey Replication/Data/Stata/panel MSA ALT.dta"
...
esttab reg1 reg2 reg3 reg4 reg5 reg6 reg7 reg8 reg9 using MSA_est_ALT.tex,  se star(* 0.10 ** 0.05 *** 0.01)  booktabs  ///
