...
panel=importdata('~/Dropbox/Double Q Survey Replication/Data/csv/panel_fef_loc.csv');
...
zz=vars(:,13:end);  % time-invariant variables 
...
filename='~/Dropbox/Double Q Survey Replication/tex/FEF_estimates_with_MSA_FE.tex';
caption = '\\begin{table}[!h]\\caption{Fixed Effects Filtered estimates with MSA fixed effects}\\centering \n';
