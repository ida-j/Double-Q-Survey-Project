...
panel=importdata('~/Dropbox/Double Q Survey Replication/Data/csv/panel_fetef_w_msa.csv');
resp=[0 456 942]; %no of response patters
filenames=cell(1,3);
filenames{1}='~/Dropbox/Double Q Survey Replication/tex/fetef_0_w_MSA.tex';
filenames{2}='~/Dropbox/Double Q Survey Replication/tex/fetef_456_w_MSA.tex';
filenames{3}='~/Dropbox/Double Q Survey Replication/tex/fetef_942_w_MSA.tex';
...
vars_wk=vars(:,1:12);
vars_fef=vars(:,13:24);
zz1=vars(:,25:(25+6+resp(s)));  
zz2=vars(:,(25+6+resp(3)+1):end);
zz=[zz1 zz2];
...
caption = '\\begin{table}[!h]\\caption{Filtered FE-TE estimates with MSA dummies}\\centering \n';
