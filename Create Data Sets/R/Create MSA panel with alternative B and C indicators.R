...
library(foreign)
source("~/Dropbox/Double Q Survey Replication/Create Data Sets/R/extra/summary stats for MSA B and C indicators.R")
stata.filename<-"~/Dropbox/Double Q Survey Replication/Data/Stata/panel MSA ALT.dta"
