%% this file performs the Wansbeek-Kapteyn transformation
...
panel=importdata('~/Dropbox/Double Q Survey Replication/Data/csv/panel_wk_h.csv');

%colanmes
%("id","t","v.e","pi.e.1m.e.new","pi.e.3m.e.new","pi.e.1y.e.new",
